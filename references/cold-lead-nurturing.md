...
> "Sales is not about closing, it's about continuing." — 冷客户不是死了，是还没醒。

## 冷客户分三层

| 层级 | 定义 | 策略 |
|------|------|------|
| 🧊 沉默层 | 发了消息从未回复（7天+） | **换钩子**：换话题/换角度/换价值点 |
...
1. **每次换饵，不重复** — 上次发产品资料，下次就发案例，再下次发行业新闻
2. **每次提供价值** — 不要"还在吗？"，要"这个对你有用"
3. **尊重沉默** — 不是不回就是没兴趣，可能只是时机不对
4. **拉长时间线** — 外贸跟单有时候是论年算的，别急
5. **自动打标签** — 连续5次不回就降权，半年一次问候即可
